/*
 *  kernel_cfg.c
 *  Tue May 17 23:55:12 2022
 *  SG Version 2.00
 *  sg ./main.oil -os=ECC2 -I/usr/local/mindstorms/nxtOSEK/toppers_osek/sg/impl_oil -template=/usr/local/mindstorms/nxtOSEK/toppers_osek/sg/lego_nxt.sgt
 */
